...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `transactions` (`id`,`memberId`,`date`,`amount`,`pointsEarned`) VALUES (nullif(?, 0),?,?,?,?)";
      }
  ...
  public Flow<List<Transaction>> getTransactionsByMember(final long memberId) {
    final String _sql = "SELECT * FROM transactions WHERE memberId = ? ORDER BY date DESC";
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Transaction(_tmpId,_tmpMemberId,_tmpDate,_tmpAmount,_tmpPointsEarned);
            _result.add(_item);
          }
          return _result;
        } finally {
